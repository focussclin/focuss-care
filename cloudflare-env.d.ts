/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 769457c9fcfecad8e81b8cb35ceefa22)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	FOCUSS_ADMIN_EMAIL: string;
	FOCUSS_ADMIN_PASSWORD: string;
	FOCUSS_ADMIN_NAME: string;
	FOCUSS_ADMIN_SESSION_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FOCUSS_ADMIN_EMAIL" | "FOCUSS_ADMIN_PASSWORD" | "FOCUSS_ADMIN_NAME" | "FOCUSS_ADMIN_SESSION_SECRET" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY">> {}
}
